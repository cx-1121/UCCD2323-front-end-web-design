...
> Cover page, member's contribution sheet, marking rubric, table of contents and Turnitin report are handled separately and are **not** included in this file — this document covers Chapters 1–4 and the reference list only, as requested.
...
In current trends, the development of electric vehicles and smart cities has accelerated due to the leveraging of Internet of Things (IoT) sensors, artificial intelligence, and data analytics to optimise municipal services [3]. Governments, organisations and communities are adopting more green technology to reduce pollution and protect the environment. However, many people, particularly students who are not majoring in energy or environmental fields, still lack awareness and understanding of these technologies and why they matter.

Therefore, the **Green Tech Club** was created to share information about renewable energy, electric vehicles, smart cities and sustainable technologies with the campus community. Rather than presenting this as a static list of facts, the club's website (RE:FUTURE) frames sustainability as a journey, moving from understanding the environmental cost of fossil fuels, to exploring how renewable energy actually works, to seeing the club's own student-led projects. Through this website, users can participate in green technology activities, test their own understanding through an interactive quiz, and follow live, sourced data on the state of the global energy transition rather than only static claims.
...
Without a dedicated website, club members and interested students face several concrete difficulties. There is no single place to learn the actual mechanism behind renewable energy sources, such as how a solar cell or a wind turbine generates electricity, rather than simply being told that these technologies exist. There is also no easy way for an outsider to see what the club has actually built or accomplished beyond word of mouth, and no lightweight way for a visitor to test or reinforce what they have just learned. Finally, there is no transparent, sourced view of how serious the underlying problem of global carbon emissions actually is, as opposed to vague statements such as "climate change is bad." A centralised, purpose-built website is therefore needed to organise this information, demonstrate the club's credibility through real project records, and make the underlying data checkable rather than merely asserted.

## 1.4 Significance

The Green Tech Club website addresses the problems described above in several concrete ways. It centralises and structures learning by organising the Explore page into five clearly explained energy sources, namely solar, wind, hydroelectric, biomass and geothermal, each covering how it works, its advantages, its limitations, and where it is used in practice, replacing scattered and inconsistent information with one consistent structure. It also favours evidence over assertion: rather than repeating the general claim that fossil fuels are harmful, the Home and Dashboard pages pull live and recent figures from public data providers such as the World Bank and Open-Meteo, so that a visitor can see the actual scale of global emissions, how the electricity mix differs between countries, and how close the world is to the IPCC's 1.5°C carbon budget. The Projects page demonstrates the club's credibility directly by documenting six real, in-progress or completed student projects, including a campus microgrid digital twin, a solar racing prototype, and an AI waste-sorting station, which lets prospective members, sponsors and faculty see that the club produces tangible engineering work rather than only discussion. The Quiz Challenge page turns passive reading into active participation by converting the Explore content into a ten-question interactive quiz, encouraging visitors to test what they have learned instead of only scrolling past it. Finally, the Contact and About pages lower the barrier to joining by making membership, collaboration and sponsorship explicit, low-friction actions, such as a pre-filled email draft, a named committee, and a stated meeting time and room, rather than leaving visitors with an ambiguous "get involved" banner. Overall, the system improves how green technology awareness is delivered on campus, gives the club's own work a permanent and citable home, and helps build a more environmentally conscious student community.

---

# Chapter 2: Literature Review

To evaluate how the Green Tech Club website compares to existing practice, three existing websites were reviewed. The first is Northvolt, a large sustainable-battery manufacturer. The second is GSTAM, the Green Science and Technology Association Malaysia, a local environmental NGO and one of the sample sites named directly in the assignment brief for this title. The third is the Boston University CleanTech Club, a university student club that is most directly comparable in scope, audience and resources to the Green Tech Club.
...
The site's main advantage is a clear, single value proposition stated immediately, backed by concrete sustainability figures and a dedicated battery-recycling programme called Revolt. It also offers comprehensive, well-segmented product information for different markets such as automotive, grid and industrial applications, suited to a technically literate audience, and it presents a clean, minimalist visual design with strong whitespace discipline, consistent typography, and multiple clearly labelled contact and career channels. At the same time, the site has clear limitations for a student audience. It is built for a corporate, investor and business-to-business audience, so its dense, text-heavy sections would be intimidating rather than inviting for a visitor with no energy background, and its sustainability claims and data visualisations are largely presented as static images or prose rather than as interactive, checkable data. There is no educational "how it works" layer for a visitor who does not already know what a lithium-ion cell or a gigafactory is, and there is no interactive or gamified element anywhere on the site, making the experience entirely read-only. For our own system, the lesson taken from Northvolt is to keep its discipline around a clear, single-sentence framing per section, while replacing its assumption of prior expertise with the plain-language, mechanism-first explanations used on our Explore page.
...
| Shows dated, concrete project output | N/A | No | Partial (undated photos) | Yes — Projects page, dated & categorised |
...
| Named, accountable ownership (committee/advisor) | N/A (corporate) | No | No | Yes — About page lists committee & faculty advisor |

Comparing the three sites against the Green Tech Club website across several practical criteria shows a consistent pattern. On explaining how a technology actually works, Northvolt does so only partially, GSTAM and the BU CleanTech Club do not attempt it at all, while the Green Tech Club's Explore page does so systematically for every source. On showing dated, concrete project output, none of the three comparators succeed: Northvolt does not apply, GSTAM shows none, and BU CleanTech Club offers only undated photographs, whereas the Green Tech Club's Projects page dates and categorises every record. None of the three comparators present live or current data rather than static claims, while the Green Tech Club's Dashboard pulls current figures from the World Bank and Open-Meteo through a RESTful API. None of the three offer an interactive or participatory element, whereas the Green Tech Club provides a ten-question Quiz Challenge. All three comparators do provide a clear, low-friction path to join or make contact, a strength the Green Tech Club matches with its mailto-based Contact form that needs no backend. On being built for a non-expert audience, Northvolt is not, GSTAM is only partially so, and both BU CleanTech Club and the Green Tech Club are. Finally, on named and accountable ownership through a listed committee or advisor, this does not apply to the corporate Northvolt site, is absent from GSTAM and BU CleanTech Club, and is present on the Green Tech Club's About page, which names its committee and faculty advisor directly.

## 2.5 How the Green Tech Club Website Differs and Improves

Across all three comparators, the same three gaps recur: claims are not backed by checkable, current data; the mechanism behind a technology is assumed or skipped rather than explained; and there is no way for a visitor to actively engage with the content beyond reading it. The Green Tech Club website was designed specifically against these gaps. Its mechanism-first education addresses the first two gaps, since every entry on the Explore page follows the same structure of how it works, its advantages, its limitations, and its real-world use, instead of only stating that a technology is "good for the environment." Its use of live, sourced data instead of static claims addresses the first gap directly, since the Dashboard and Home pages call public RESTful APIs, namely Open-Meteo for live weather and the World Bank API for emissions and renewable-share statistics, through jQuery, so that the figures shown are fetched at request time and explicitly dated and attributed rather than being a paragraph of text the reader has to take on faith. Its gamified reinforcement through the Quiz Challenge page addresses the third gap and is the one feature none of the three comparator sites offer, giving visitors a way to actively test their understanding rather than passively read it. The Projects page further demonstrates rather than merely claims credibility, listing six dated, categorised projects with concrete metrics such as classification accuracy, efficiency, and savings identified, closer in spirit to a lab notebook than a brochure. Finally, the site uses storytelling as onboarding: the cinematic Landing sequence gives first-time visitors an emotional "why" before the informational "what," an approach none of the three comparators attempt.
...
![Site map of the Green Tech Club website](assets/wireframes/sitemap.svg)
...
![Landing page wireframe](assets/wireframes/wireframe-landing.svg)
...
![Home page wireframe](assets/wireframes/wireframe-home.svg)
...
![Explore page wireframe](assets/wireframes/wireframe-explore.svg)
...
![Projects page wireframe](assets/wireframes/wireframe-projects.svg)
...
![Quiz Challenge page wireframe](assets/wireframes/wireframe-quiz-challenge.svg)
...
![About page wireframe](assets/wireframes/wireframe-about.svg)
...
![Contact page wireframe](assets/wireframes/wireframe-contact.svg)
...
![Dashboard page wireframe](assets/wireframes/wireframe-dashboard.svg)
...
Finally, selecting Dashboard shows the carbon-budget headline reading "6.3 years left," four sourced metric cards, a 2015–2024 sector-emissions chart, a per-country electricity-mix comparison, and the "Live conditions" panel at the bottom, which fetches current solar irradiance and wind speed for Kuala Lumpur while the visitor is on the page. `[SCREENSHOT: the headline carbon-budget figure and the four metric cards]` and `[SCREENSHOT: the "Live conditions" panel, ideally captured while it briefly shows "FETCHING…" and again once the numbers have loaded]`.
...
| `sessionStorage` | In-progress quiz answers/score, and the cached Dashboard/Home API responses (energy and carbon snapshots) | Data that should reset on a fresh visit but survive a same-tab refresh — a stale cached statistic or an abandoned quiz attempt should not leak into the next visit |
...
[3] A. Gomstyn and A. Jonker, "What is a smart city?," IBM Think, 2023. [Online]. Available: https://www.ibm.com/think/topics/smart-city. [Accessed: 17-Aug-2026].
